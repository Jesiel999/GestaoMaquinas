<div id="maquina-edit" class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center hidden z-50">
    <div class="bg-white p-6 rounded-lg shadow-md max-w-2xl w-full relative">

        <button id="close-maquina-edit" 
            class="absolute top-2 right-2 text-gray-500 hover:text-gray-700 text-2xl font-bold">
            &times;
        </button>

        <div class="flex justify-between">
            <h2 class="text-lg font-bold mb-4">Editar Máquina</h2>
            <h2 class="text-lg font-bold mb-4 mr-5">Código: <input id="edit-codigo" step="0.01" name="maqu_codigo"/></h2>
        </div>
        ...
        <form id="form-edit" method="POST" action="">
            ...
            <div class="flex justify-end space-x-3 mt-4">                     
                <button type="button" id="cancel-maquina-edit" 
