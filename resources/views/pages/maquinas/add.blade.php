<div id="maquina-modal" class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center hidden z-50">
    <div class="bg-white p-6 rounded-lg shadow-md 
                w-[95%] max-w-4xl max-h-[90vh] 
                overflow-y-auto relative">

        <button id="close-maquina-modal" 
            class="absolute top-2 right-2 text-gray-500 hover:text-gray-700 text-2xl font-bold">
            &times;
        </button>

        <h2 class="text-lg font-bold mb-4">Cadastro de Nova Máquina</h2>
        ...
        <form method="POST" action="" class="space-y-4">
            ...
            <div class="flex justify-end space-x-3">
                <button type="button" id="cancel-maquina" class="px-4 py-2 border rounded-lg text-gray-700 hover:bg-gray-100">
                    Cancelar
                </button>
